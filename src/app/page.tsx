...
const selectedWorkSlideConfigs: SelectedWorkSlideConfig[] = [
  { match: 'Mielle', brand: 'Mielle', campaign: 'Super Bowl', carouselImage: '/images/clients/mielle-carousel-product.jpg' },
  ...
  { match: 'Women Raise the Game', brand: 'Women Raise the Game', campaign: '', carouselImage: '/images/clients/wrtg-carousel-superbowl.jpg' },
  { match: 'AT&T Dream in Black', brand: 'AT&T', campaign: 'Dream in Black', carouselImage: '/images/clients/att.webp', carouselVideo: '/videos/att-dreaminblack-carousel.mp4' },
